...
These packages are designed to be installed into a context-kit project (or any Next.js + Prisma stack) and provide common SaaS functionality with a "fix once, inherit everywhere" model. Update a package version and every project gets the fix.

## Packages

| Package | Description | Status |
|---------|-------------|--------|
| [`@context-kit/auth`](./packages/auth) | Authentication powered by Better Auth with Prisma, pre-configured for Next.js App Router | In progress |
...
- **Packages, not code drops.** Bug fixes and improvements propagate to every project via `pnpm update`.
...
- **Prisma-native.** Packages extend your Prisma schema rather than fighting it.
